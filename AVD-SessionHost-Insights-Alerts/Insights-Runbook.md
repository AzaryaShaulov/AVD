# AVD Session Host Insights Alerts — Operational Runbook

Procedures for responding to AVD Session Host Insights Alerts category-consolidated alerts. Each alert covers
...
## AVD-SessionHost-Insights-Category-HostPerformance
...
## AVD-SessionHost-Insights-Category-DiskHealth
...
## AVD-SessionHost-Insights-Category-SessionLifecycle
...
**Triage Steps:**
1. Verify `_maxSessionLimit` in `queries/category-session-lifecycle.kql` matches your actual host pool configuration
...
- Adjust `_maxSessionLimit` in `queries/category-session-lifecycle.kql` if your actual limit differs
...
## AVD-SessionHost-Insights-Category-CorrelatedSignals
...
## AVD-SessionHost-Insights-Category-EventLogAlerts
...
## AVD-SessionHost-Insights-Category-GPUPerformance
